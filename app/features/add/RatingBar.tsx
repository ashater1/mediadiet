...
import { FavoriteHeart } from "../v2/list/icons/icons";
  ...
  return (
    <div className="flex gap-2">
      ...
      <button
        type="button"
        className={classNames(
          _favorited ? "border-primary-800" : "border-primary-800/30",
          "cursor-pointer rounded-full border p-2 transition-colors focus:outline-none focus-visible:border-white "
        )}
